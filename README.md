...
- SVG character placeholder ทั้ง 9 type พร้อม prompt สำหรับ generate ภาพจริงใน `docs/image-prompts.md`
...
โปรเจกต์มี SVG placeholder ที่ใช้งานได้จริงใน `src/assets/characters/` และมี prompt สำหรับสร้างภาพตัวละครจริงทั้ง 9 type ใน `docs/image-prompts.md` โดยหลีกเลี่ยงการเลียนแบบศิลปินหรือสตูดิโอเฉพาะ
