...
- WebP character art แบบ original modern anime-inspired ครบทั้งหญิงและชายสำหรับทั้ง 9 type รวม 18 รูป พร้อม prompt อ้างอิงใน `docs/image-prompts.md`
- ถามเพศผู้ทำแบบทดสอบก่อนเริ่ม และแสดงตัวละครผลลัพธ์ให้ตรงกับเพศที่เลือก
...
โปรเจกต์มี WebP character art ที่สร้างเป็น original modern anime-inspired characters ใน `src/assets/characters/` ครบทั้ง `male` และ `female` สำหรับทุก Type ไฟล์ถูก optimize จากภาพต้นฉบับเพื่อให้หน้าแรกโหลดเร็วขึ้น และมี prompt สำหรับสร้างซ้ำหรือปรับเวอร์ชันภาพใน `docs/image-prompts.md` โดยหลีกเลี่ยงการเลียนแบบศิลปินหรือสตูดิโอเฉพาะ
